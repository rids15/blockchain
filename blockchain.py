...
# Generate globally unique identifier for this node
...
def mine():
    ...
    print("starting of mine")
    last_block = blockchain.last_block
    last_proof = last_block['proof']
    proof = blockchain.proof_of_work(last_proof)

    print("after poa")
    # We should receive reward sender 0 signify this node has mined new coin
...
def consensus():
    ...
    if replaced:
        response = {
            'messgae': 'Our chain replaced',
            'new_chain': blockchain.chain
        }
    else:
        response = {
            'message': 'Our  chain is autorative',
            'chain': blockchain.chain
        }
